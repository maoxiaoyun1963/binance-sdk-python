...
from .all_order_lists_response_result_inner import AllOrderListsResponseResultInner
...
class OrderListStatusResponse(BaseModel):
    ...
    result: Optional[AllOrderListsResponseResultInner] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    AllOrderListsResponseResultInner.from_dict(obj["result"])
