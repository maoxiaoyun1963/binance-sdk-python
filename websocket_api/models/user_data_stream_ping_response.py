...
class UserDataStreamPingResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "response", "rateLimits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserDataStreamPingResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserDataStreamPingResponse from a dict"""
        if obj is None:
            return None
