...
from .user_data_stream_start_response_result import UserDataStreamStartResponseResult


class UserDataStreamStartResponse(BaseModel):
    """
    ...
    result: Optional[UserDataStreamStartResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserDataStreamStartResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserDataStreamStartResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    UserDataStreamStartResponseResult.from_dict(obj["result"])
