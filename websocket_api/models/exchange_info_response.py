...
from .exchange_info_response_result import ExchangeInfoResponseResult
...
class ExchangeInfoResponse(BaseModel):
    ...
    result: Optional[ExchangeInfoResponseResult] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    ExchangeInfoResponseResult.from_dict(obj["result"])
