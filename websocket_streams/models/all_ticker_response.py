...
from .all_ticker_response_inner import AllTickerResponseInner


class AllTickerResponse(AllTickerResponseInner):
    """
    AllTickerResponse
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllTickerResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllTickerResponse from a dict"""
        if obj is None:
            return None
